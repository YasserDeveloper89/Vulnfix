...
# Mostrar resultados si se selecciona un distrito
if distrito_seleccionado != "Selecciona...":
    ...
    # Usamos container para agrupar el contenido y evitar espacio innecesario
    with st.container():
        ...
        # Footer sin generar espacio innecesario
        st.markdown(
            """
            <div style="text-align: center; font-size: 0.85em; color: #888; margin-top: 2rem;">
